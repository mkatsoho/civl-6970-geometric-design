...
\draw [shift={(0.29,3.33)},line width=2pt,color=qqwuqq,fill=qqwuqq,fill opacity=0.10000000149011612] (0,0) -- (146.9644928751379:0.41579375396997176) arc (146.9644928751379:180:0.41579375396997176) -- cycle;
...
\draw[color=qqwuqq] (-3.8118266454870104,-2.6464345277356704) node {$\Delta$};
\draw [fill=xdxdff] (2.054288598301511,10.374072899468619) circle (2.5pt);
\draw[color=qqwuqq] (-3.188136014532053,6.4182743427627065) node {$\Delta$};
\draw[color=qqwuqq] (-0.4438972383302392,3.6807043294843056) node {$\Delta$/2};
\end{scriptsize}
\end{tikzpicture}
\end{document}